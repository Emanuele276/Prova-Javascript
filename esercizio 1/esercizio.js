// 1. Dichiara alcune variabili di tipo
diverso
let nomeStudente = "Mario";
let etaStudente = 20;
...
let primaParte = "Ciao, io sono Emanuele " ;
let secondaParte = "e ho 25 " ;
let terzaParte = " 25 anni " ;
...
// Apri la pagine in un browser e osserva il comportamento
let colorePreferito = prompt( "Qual è il tuo colore preferito? ") ;
console.log( "Il colore preferito inserito è . blu" , colorePreferito) ;
